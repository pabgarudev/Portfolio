...
<Diagram
  name="camera-network-overlap"
  caption="The 2024 method needs an overlap for every link. The 2025 method has a mobile camera carry the relationships instead."
/>
...
<Diagram
  ...
  caption="The same overlapping-view floor dataset, measured both ways."
/>
